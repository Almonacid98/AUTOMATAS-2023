...
url_op2 = re.compile("^(www\.)+([a-zA-Z0-9.-])+\.(com|es|ar|net|org|um\.edu\.ar|edu\.ar|edu\.com|edu\.org|cl|co|cn|ae|au|br|ca|nz)+\.(ar|cl|co|cn|ae|au|br|ca|nz|es)$")
url_op3 = re.compile("^([a-zA-Z0-9.-])+\.(com|es|co|ar|net|org|um|edu)+\.(ar|cl|co|cn|ae|au|br|ca|nz|es|edu)+\.(ar|cl|co|cn|ae|au|br|ca|nz|es|edu)$")
